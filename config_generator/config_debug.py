...
s3_handle.put("/tabot/play_library/paper/symbol_categories", json.dumps(["crypto_alt"]))
s3_handle.put("/tabot/play_library/paper/market_conditions", json.dumps(["bull"]))
s3_handle.put(
    "/tabot/play_library/paper/crypto_alt/symbols",
    json.dumps(["AVAX-USD", "SOL-USD", "XRP-USD"]),
)

# paths = {
#    "telemetry_sqs": "/tabot/telemetry/queue/backtest",
# }
# s3_handle.put("/tabot/play_library/paper/config", json.dumps(["SOL-USD"]))
